...
public final class Logger {
	...
	public static void log(Throwable t, Object obj) {
		...
		System.out.println(
				"[MEMORY:" + String.valueOf(Runtime.getRuntime().totalMemory() - Runtime.getRuntime().freeMemory())
						+ "]" + "[" + sdf.format(Calendar.getInstance().getTime()) + "] " + "[" + element.getClassName()
						+ "] " + "[" + element.getMethodName() + "] " + "[" + element.getLineNumber() + "] " + obj);
	}
	...
	public static void log(final Exception e) {
		System.out.println("■ 例外発生: " + "[" + e.getStackTrace()[0].getClassName() + "] ["
